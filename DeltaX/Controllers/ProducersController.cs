...
namespace DeltaX.Controllers
{
    public class ProducersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,MovieId,Name,Sex,DOB,Bio")] Producer producer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MovieId,Name,Sex,DOB,Bio")] Producer producer)
        {
            if (id != producer.Id)
            {
                return NotFound();
